...
df_train = df.drop(["participant", "category", "set","cluster"], axis=1) # CLUSTER is DROPED BY NIKHIL
...
## NIKHIL NAIK FULL MODIFIED

X_test_feature_set_3 = X_test[sorted(feature_set_3)]
X_train_feature_set_3 = X_train[sorted(feature_set_3)]
...
(
    ...
    X_train_feature_set_3, y_train, X_test_feature_set_3, gridsearch=True
)
...
X_test_feature_set_4 = X_test[feature_set_4]
X_test_feature_set_4_col = list(X_test_feature_set_4.columns)
my_prediction = rfmodel.predict(X_test[feature_set_4])                                           # NIKHIL NAIK MOD
...
# --------------------------------------------------------------
# Try a more simpler model with the selected features
# --------------------------------------------------------------

# selected_features = []   #-------------------copy past the selected_features
