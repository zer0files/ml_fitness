...
ax[0].plot(loc="upper center", bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True)
ax[1].plot(loc="upper center", bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True)
